...
export const ComunionForm:FC<FormProps> = ({hSubmit, oSubmit, reg, err, reseter}) => {
  ...
  return (
    <form onSubmit={hSubmit(oSubmit)}> 
                <Grid2 container direction='column' justifyContent='center' alignItems='center' height='400px' sx={{overflowY: 'scroll'}}>
                  ...
                  <FormControl sx={{mt:2, position:'relative'}} error={!!err.fechaComunion}>
                    <FormLabel>Fecha de bautizo *</FormLabel>
                      <input type="date" placeholder="fechaComunion" {...reg("fechaComunion", {required: true})} />
                      {err.fechaComunion &&
                                  <FormHelperText>
                                    <InfoOutlined />
                                    Requerido
                  ...
                  <FormControl sx={{mt:2, position:'relative', ml: 2}}>
                  ...
                  <Grid2 container direction='row' p={1} mt={2} justifyContent='center' alignItems='center' border='1px solid grey' borderRadius={5} boxShadow={2} px={2}>
                  <FormControl sx={{mt:2, position:'relative'}} error={!!err.comunionNombre}>
                    <FormLabel>Nombre completo*</FormLabel>
                    <Input
                        sx={{top: -15}}
                        type="text"
                        {...reg("comunionNombre", {required: true})}
                    />
                    {err.comunionNombre &&
                                <FormHelperText>
                                  <InfoOutlined />
                    ...
                    <FormControl sx={{mt:2, position:'relative', mx:2}} error={!!err.madreNombre}>
