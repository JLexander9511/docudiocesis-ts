...
import { serverResponse } from "../bautismo/Bautismo"
import { getAllRegs } from "@/app/api/controllers"
import { Bounce, toast } from "react-toastify"
import { RootState } from "@/store/RootState"
import { TypedUseSelectorHook, useSelector } from "react-redux"
import Table from "../../components/Table"

export const Comunion = () => {
  ...
  return (
    ...
    <Typography variant='h2' fontSize={32} mb={1} width='30%' mt={1}>Actas de Comunión</Typography>
